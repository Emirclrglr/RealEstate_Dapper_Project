...
namespace RealEstate_Dapper_UI.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(IHttpClientFactory httpClientFactory, IApiSettings api)
        {
        ...
        public async Task<IActionResult> Index(SignInDto dto)
        {
            ...
            var responseMessage = await client.PostAsync($"https://localhost:44366/api/Login", content);
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                if (tokenModel != null)
                {
                    ...
                    if (tokenModel.Token != null)
                    {
                        ...
                        return RedirectToAction("MyAdverts", "EstateAgent", "Index");
